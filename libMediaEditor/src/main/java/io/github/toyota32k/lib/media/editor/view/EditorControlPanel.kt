...
class EditorControlPanel @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    fun bindViewModel(model: MediaEditorModel, binder: Binder) {
        ...
        binder
            ...
            .visibilityBinding(controls.editorMainButtonPanelViewbox, model.editMode.map { it == MediaEditorModel.EditMode.NORMAL})
            .visibilityBinding(controls.cropPanelViewbox, model.editMode.map { it == MediaEditorModel.EditMode.CROP})
